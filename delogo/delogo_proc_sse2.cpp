...
void __stdcall func_smooth_3x3_sse2(short *dst, short *src, const short *mask, int width, int src_pitch, int height) {
    smooth_simd<1>(dst, src, mask, width, src_pitch, height);
}

void __stdcall func_smooth_5x5_sse2(short *dst, short *src, const short *mask, int width, int src_pitch, int height) {
    smooth_simd<2>(dst, src, mask, width, src_pitch, height);
}

void __stdcall func_smooth_7x7_sse2(short *dst, short *src, const short *mask, int width, int src_pitch, int height) {
    smooth_simd<3>(dst, src, mask, width, src_pitch, height);
}

void __stdcall func_smooth_9x9_sse2(short *dst, short *src, const short *mask, int width, int src_pitch, int height) {
    smooth_simd<4>(dst, src, mask, width, src_pitch, height);
}

void __stdcall func_smooth_yc48_3x3_sse2(PIXEL_YC *ptr, const short *mask, int width, int src_pitch, int height) {
    smooth_simd<1>(nullptr, ptr, mask, width, src_pitch, height);
}

void __stdcall func_smooth_yc48_5x5_sse2(PIXEL_YC *ptr, const short *mask, int width, int src_pitch, int height) {
    smooth_simd<2>(nullptr, ptr, mask, width, src_pitch, height);
}

void __stdcall func_smooth_yc48_7x7_sse2(PIXEL_YC *ptr, const short *mask, int width, int src_pitch, int height) {
    smooth_simd<3>(nullptr, ptr, mask, width, src_pitch, height);
}

void __stdcall func_smooth_yc48_9x9_sse2(PIXEL_YC *ptr, const short *mask, int width, int src_pitch, int height) {
